...
export const SearchBarButton = () => {
  ...
  const handleAnimeSelect = (anime) => {
    ...
    let contenedor = document.getElementById('hide')
    let topAni = document.getElementById('topAnime')
    let Btmes = document.getElementById('Btmes')
    let Media = document.getElementById('Media')
    Btmes.style = "display:none;"
    contenedor.style = "display:none;"
    topAni.style = "display:none;"
            ...
            {searchResults.length > 0 ? (
              searchResults.map((anime) => (
                ...
                >
                  ...
                  <div>
                    <h4 className='hFourPrin'>{anime.title}</h4>
                    <p className='pPrin'>Episodios: {anime.episodes ? anime.episodes : 'Desconocido'}</p>
                  </div>
                </div>
              ))
            ) : (
